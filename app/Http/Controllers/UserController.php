...
class UserController extends Controller
{
    ...
    public function postAdd(Request $request)
    {
        $this->validate($request,
            [
                ...
                'txtEmail' => 'required|email|unique:thanhvien,email',
        ...
        $user = new User;
        $user->ten_admin = $request->txtHoten;
        $user->email = $request->txtEmail;
        $user->password = bcrypt($request->txtPass);
        $user->quyen = $request->rdoQuyen;
        $user->save();

        return redirect('admin/thanhvien/list')->with('thongbao', 'Thêm thành công');
    }

    public function getEdit($id)
    {
        $user = User::find($id);
        return view('admin.infoUser',['user'=>$user]);
    }
    ...
    public function postEdit(Request $request, $id)
    {
        ...
        $user->save();
        return redirect('admin/thanhvien/list')->with('thongbao', 'Cập nhật thành công');
    }
    ...
    public function getDel($id)
    {
        $user = User::find($id);
        $user->delete();
        return redirect('admin/thanhvien/list')->with('thongbao', 'Đã xóa thành công');
    }
    ...
    public function postLoginAdmin(Request $request)
    {
        ...
        {
            return redirect('admin/thongtindv/list');
        }
        else
